...
public class TRC20AccountUtils {
...
//		 //通过公钥生成钱包地址
//		 String hexAddress ="41" + Keys.getAddress(eCKeyPair.getPublicKey());
...
//		 }
//		 
//		 ApiWrapper keyPair = new ApiWrapper(privatekey);
//		 
...
//	     return ByteArray.toHexString(KeyPair.decodeFromBase58Check(addressT));
//	 }
