...
//		//查找bsc 账户
//		List<AccountInfo>  bAccountList=adao.findByTypeOrderByCreateTimeDesc("BSC");
//		
//		//分页及查找
////		Page<Pagemail> pagelist=mservice.recive(page, size, user, null,"收件箱");
////		List<Map<String, Object>> maillist=mservice.mail(pagelist);
//		
//		Page<AccountInfo> pagelist=aServices.pages(page, size, null,"ETH");
...
//		
//		Page<AccountInfo> pagelist=aServices.pages(page, size, null,type);
//		List<Map<String, Object>> alist=aServices.sendToken(pagelist);
//		
//		model.addAttribute("page", pagelist);
//		model.addAttribute("alist",alist);
...
//		
//		List<SystemTypeList> tokenlist=tydao.findByTypeModel("aoa_token");
//		List<SystemTypeList> walletlist=tydao.findByTypeModel("main_wallet");
...
//		
//		aServices.pushToken(fromAddress,amount,tokenType,addressIds);
//		
...
//		String addressIds=request.getParameter("addressIds");
//		
//		aServices.imputationToken(toAddress,amount,tokenType,addressIds);
//		
...
//			String nextToken = st.nextToken();
//			AccountInfo  aAccountInfo=adao.findByAccountId(Long.parseLong(nextToken));
//			aServices.updateBlance(aAccountInfo);
//		}
//		
//		Page<AccountInfo> pagelist=aServices.pages(page, size, null,type);
//		List<Map<String, Object>> alist=aServices.sendToken(pagelist);
...
//		
//		Page<AccountInfo> pagelist=aServices.index(page, size, tu, null,model);
//		List<Map<String, Object>> list=aServices.up(pagelist);
//		
...
////		Page<AccountInfo> pagelist=aServices.index(page, size, tu, null,model);
//		
//		List<Map<String, Object>> list=aServices.creatAccount(val);
//		
//		model.addAttribute("account", list);
////		model.addAttribute("page", pagelist);
