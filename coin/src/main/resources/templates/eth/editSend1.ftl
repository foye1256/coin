...
<div class="bgc-w box box-primary" style="min-height: 613px;">
	...
	<!--盒子身体-->
	<form action="pushImputationToken" method="post" enctype="multipart/form-data" onsubmit="return check();" >
	<div class="box-body">
		<!--錯誤信息提示  -->
		...
		<div id="MoreDiv">
			...
			<div class="form-group">
				...
				<input name="toAddress" type="text" value="${(toAddress)!''}"
					id="ctl00_cphMain_txtSubject" class="form-control" placeholder="接收地址：" />
			</div>
	...
	<div class="box-footer foots">
		<div class="left1">
			<a id="ctl00_cphMain_lnbDiscard" class="btn btn-default " href="imputationToken"><span>放弃</span></a>
		</div>
		<div class="pull-right right1 ">
		    <!-- <input type="submit" class="btn btn-default" value="存草稿"> -->
			<input type="submit" class="btn btn-primary " name="fasong" value="归集">
