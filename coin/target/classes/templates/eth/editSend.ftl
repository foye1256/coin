...
<div class="bgc-w box box-primary" style="min-height: 613px;">
	...
	<!--盒子身体-->
	<form action="pushToken" method="post" enctype="multipart/form-data" onsubmit="return check();" >
	<div class="box-body">
		<!--錯誤信息提示  -->
		...
		<div class="box-footer foots">
			<div class="left1">
				<a id="ctl00_cphMain_lnbDiscard" class="btn btn-default " href="sendToken"><span>放弃</span></a>
			</div>
