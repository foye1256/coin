...
<div class="box-header">
	...
	<div class="box-tools1">
		<div class="input-group" style="width: 550px; margin-top: 0px;">
			<div class="input-group" style="width: 150px; margin-top: 5px; float:left;">
			...
			<div class="input-group" style="width: 150px; left:10px;margin-top: 5px; float:left;">
				<input type="text" class="form-control input-sm remake" placeholder="备注" />
			</div>
			
			<div class="input-group" style="width: 150px; left:20px; margin-top: 5px; float:left;">
