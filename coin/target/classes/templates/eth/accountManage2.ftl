				...
				<div class="alert alert-danger alert-dismissable" role="alert"
					...
					<div class="row">
						...
						<div class="col-md-9 form-group">
							...
							<input class="form-control" name="remake" value="${(remake)!''}" placeholder="请输入备注信息"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>数量</span></label> 
							<input class="form-control" name="num" value="${(num)!''}" placeholder="请输入钱包数量"/>
						</div>
				</div>
			</div>
		</div>
